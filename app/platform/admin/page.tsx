    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <div style={{
        ...
        <StatCard
          ...
          sub="ส่วนแบ่งคอมมิชชั่นตามสัญญา (Snapshot Fee)"
          icon={TrendingUp}
          valueColor="#315EC3"
        />
        <StatCard
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
            ...
            <Link href="/platform/admin/finance" style={{ fontSize: 12.5, color: '#315EC3', textDecoration: 'none', fontWeight: 700, display: 'flex', alignItems: 'center', gap: 3 }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            <Link href="/platform/admin/invitations" style={{
            ...
            <Link href="/platform/admin/shops" style={{
              display: 'flex', alignItems: 'center', justifyContent: 'space-between',
            ...
            <Link href="/platform/admin/finance" style={{
              display: 'flex', alignItems: 'center', justifyContent: 'space-between',
              padding: '12px 16px', borderRadius: 12, background: '#FFFFFF',
              color: '#1A2340', textDecoration: 'none', fontWeight: 700, fontSize: 13.5,
              border: '1.5px solid #E8EEF8'
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18 }}>
          ...
          <Link href="/platform/admin/shops" style={{ fontSize: 13, color: '#315EC3', textDecoration: 'none', fontWeight: 700, display: 'flex', alignItems: 'center', gap: 4 }}>
            ...
            <div key={shop.id} style={{
              ...
              <div style={{ textAlign: 'right' }}>
                ...
                <div style={{ fontSize: 11.5, color: '#315EC3', fontWeight: 600 }}>
                  ฿{((shop.total_revenue || 0) * (shop.platform_fee_pct !== undefined && shop.platform_fee_pct !== null ? (shop.platform_fee_pct > 1 ? shop.platform_fee_pct / 100 : shop.platform_fee_pct) : 0.15)).toLocaleString('th', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} fee
                </div>
              </div>
            </div>
          ))}
